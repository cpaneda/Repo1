...
//		return;
	...
	float vFB_Start          = 0.0;
	float vStep              = 0.0;
	float CV_minus1p5pct_Pre = 0.0;
	float CV_minus1p5pct_Pst = 0.0;
	float CV_plus1p5pct_Pre  = 0.0;
	float CV_plus1p5pct_Pst  = 0.0;
	float i_HSG          = 0.0;
	int   i              = 0;
	int   loop_1         = 0;
	int   loop_2         = 0;
...
Pulse pulse;
	...
	CV_S_code[i] =  8; CV_S_TrimWt[i] =  4.0;    i++;    //0 (1 link trimmed-->  4.0%)
	CV_S_code[i] =  9; CV_S_TrimWt[i] =  3.5;    i++;    //0 (2 link trimmed-->  3.5%)
	CV_S_code[i] = 10; CV_S_TrimWt[i] =  3.0;    i++;    //0 (2 link trimmed-->  3.0%)
	CV_S_code[i] = 11; CV_S_TrimWt[i] =  2.5;    i++;    //0 (3 link trimmed-->  2.5%)
	CV_S_code[i] = 12; CV_S_TrimWt[i] =  2.5;    i++;    //0 (2 link trimmed-->  2.5%)
	CV_S_code[i] = 13; CV_S_TrimWt[i] =  2.0;    i++;    //0 (3 link trimmed-->  2.0%)
	CV_S_code[i] = 14; CV_S_TrimWt[i] =  1.5;    i++;    //0 (3 link trimmed-->  2.0%)
	CV_S_code[i] = 15; CV_S_TrimWt[i] =  1.0;    i++;    //0 (4 link trimmed-->  1.0%)
	...
	if(0)
	{
		...
		//This method is having issue, seeming to measure the CV-1.6% instead.
		DSM_I2C_Write('w', g_S_ANA_CTRL_0, 0x0010);
	...
	else
	{
			...
			DSM_I2C_Write('w', g_S_ANA_CTRL_1, 0xF000); 
			...
			CV_Search(CV_minus1p5pct_Pre, CV_pt_S, CV_plus1p5pct_Pre, vFB_Start, vStep);
	}
	...
	converted_dec = Convert_BIN_2_Dec(WordArray);
...
pulse.do_pulse();
	...
	vFB_Start = 1.1;
	vStep = 2e-3;
	CV_Search(CV_minus1p5pct_Pst, CV_prg_S, CV_plus1p5pct_Pst, vFB_Start, vStep);
