...
// Datalog gFuncNum variable //
	...
	// Skip trimming if g_s_Trim_Enable is not set //
	if (g_s_Trim_Enable == 0)
		return;
...
Pulse pulse;
	...
	VccRef_S_code[i] = 16; VccRef_S_TrimWt[i] =  -0.75;  i++;     
	VccRef_S_code[i] = 17; VccRef_S_TrimWt[i]  = -1.50;  i++;     
	VccRef_S_code[i] = 18; VccRef_S_TrimWt[i]  = -2.25;  i++;    
	VccRef_S_code[i] = 19; VccRef_S_TrimWt[i]  = -3.00;  i++;    
	VccRef_S_code[i] = 20; VccRef_S_TrimWt[i]  = -3.75;  i++;     
	VccRef_S_code[i] = 21; VccRef_S_TrimWt[i]  = -4.50;  i++;     
	VccRef_S_code[i] = 22; VccRef_S_TrimWt[i]  = -5.25;  i++;     
	VccRef_S_code[i] = 23; VccRef_S_TrimWt[i]  = -6.00;  i++;     
	VccRef_S_code[i] = 24; VccRef_S_TrimWt[i] =  -6.75;  i++;     
	VccRef_S_code[i] = 25; VccRef_S_TrimWt[i] =  -7.50;  i++;     
	VccRef_S_code[i] = 26; VccRef_S_TrimWt[i] =  -8.25;  i++;     
	VccRef_S_code[i] = 27; VccRef_S_TrimWt[i] =  -9.00;  i++;     
	VccRef_S_code[i] = 28; VccRef_S_TrimWt[i] =  -9.75;  i++;    
	VccRef_S_code[i] = 29; VccRef_S_TrimWt[i] =  -10.50; i++;     
	VccRef_S_code[i] = 30; VccRef_S_TrimWt[i] =  -11.25; i++;     
	VccRef_S_code[i] = 31; VccRef_S_TrimWt[i] =  -12.00; i++;    
...
////////	DSM_I2C_Write('w', g_S_ANA_CTRL_1, 0x00E0);
////////
