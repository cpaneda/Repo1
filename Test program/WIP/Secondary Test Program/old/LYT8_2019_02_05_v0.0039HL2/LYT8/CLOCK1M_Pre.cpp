...
Pulse pulse;
	...
	CLK1M_S_code[i] =  1; CLK1M_S_TrimWt[i] =  4;    i++;     //0 (1 link trimmed--> -1.0%)
	CLK1M_S_code[i] =  2; CLK1M_S_TrimWt[i] =  8;    i++;     //0 (1 link trimmed--> -2.0%)
	CLK1M_S_code[i] =  3; CLK1M_S_TrimWt[i] =  12;    i++;     //0 (2 link trimmed--> -3.0%)
	CLK1M_S_code[i] =  4; CLK1M_S_TrimWt[i] =  16;    i++;     //0 (1 link trimmed--> -4.0%)
	CLK1M_S_code[i] =  5; CLK1M_S_TrimWt[i] =  20;    i++;     //0 (2 link trimmed--> -5.0%)
	CLK1M_S_code[i] =  6; CLK1M_S_TrimWt[i] =  24;    i++;     //0 (2 link trimmed--> -6.0%)
	CLK1M_S_code[i] =  7; CLK1M_S_TrimWt[i] =  28;    i++;     //0 (3 link trimmed--> -7.0%)
	CLK1M_S_code[i] =  8; CLK1M_S_TrimWt[i] = -32;    i++;     //0 (1 link trimmed-->  1%)
	CLK1M_S_code[i] =  9; CLK1M_S_TrimWt[i] = -28;    i++;     //0 (2 link trimmed-->  2%)
	CLK1M_S_code[i] = 10; CLK1M_S_TrimWt[i] = -24;    i++;     //0 (2 link trimmed-->  3%)
	CLK1M_S_code[i] = 11; CLK1M_S_TrimWt[i] = -20;    i++;     //0 (3 link trimmed-->  4%)
	CLK1M_S_code[i] = 12; CLK1M_S_TrimWt[i] = -16;    i++;     //0 (2 link trimmed-->  5%)
	CLK1M_S_code[i] = 13; CLK1M_S_TrimWt[i] = -12;    i++;     //0 (3 link trimmed-->  6%)
	CLK1M_S_code[i] = 14; CLK1M_S_TrimWt[i] =  -8;    i++;     //0 (3 link trimmed-->  7%)
	CLK1M_S_code[i] = 15; CLK1M_S_TrimWt[i] =  -4;    i++;     //0 (4 link trimmed-->  8%)
//////////
//////////	
