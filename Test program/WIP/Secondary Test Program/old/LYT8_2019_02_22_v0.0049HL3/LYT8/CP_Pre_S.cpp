...
Pulse pulse;
	...
	CP_IS_S_code[i] =  3;  CP_IS_S_TrimWt[i]  =  -8.40;  i++;    
	CP_IS_S_code[i] =  4;  CP_IS_S_TrimWt[i]  =   2.80;  i++;     
	CP_IS_S_code[i] =  5;  CP_IS_S_TrimWt[i]  =   5.60;  i++;     
	CP_IS_S_code[i] =  6;  CP_IS_S_TrimWt[i]  =   8.40;  i++;     
	CP_IS_S_code[i] =  7;  CP_IS_S_TrimWt[i]  =   11.20; i++;     
	CP_IS_S_code[i] =  8;  CP_IS_S_TrimWt[i]  =      0;   i++;     
	CP_IS_S_code[i] =  9;  CP_IS_S_TrimWt[i]  =  -2.80;  i++;     
	CP_IS_S_code[i] =  10; CP_IS_S_TrimWt[i]  =  -5.60;  i++;    
	CP_IS_S_code[i] =  11; CP_IS_S_TrimWt[i]  =  -8.40;  i++;    
	CP_IS_S_code[i] =  12; CP_IS_S_TrimWt[i]  =   2.80;  i++;     
	CP_IS_S_code[i] =  13; CP_IS_S_TrimWt[i]  =   5.60;  i++;     
	CP_IS_S_code[i] =  14; CP_IS_S_TrimWt[i]  =   8.40;  i++;     
	CP_IS_S_code[i] =  15; CP_IS_S_TrimWt[i]  =   11.20; i++;  
...
//////////
//////////
//////////	ccPFOFF_TrCode_S   = smallest_diff_idx;
...
////////////////	if(ccPFOFF_S_code[smallest_diff_idx]>=0 && ccPFOFF_S_code[smallest_diff_idx] <= 2)
////////////////	{
...
//////////
//////////	//Update WordArray.
//////////	WordArray[3]        = g_S_TrimRegisterTemp[35]; 
//////////	WordArray[4]        = g_S_TrimRegisterTemp[36]; 
//////////	WordArray[5]        = g_S_TrimRegisterTemp[37]; 
//////////
//////////
//////////	//Update secondary trim register array for programming later.
//////////	g_S_TrimRegister[35] = g_S_TrimRegisterTemp[35]; 
//////////	g_S_TrimRegister[36] = g_S_TrimRegisterTemp[36]; 
//////////	g_S_TrimRegister[37] = g_S_TrimRegisterTemp[37]; 
//////////
//////////
...
//////////		PiDatalog(func, A_Eetr35_Icc0_S,      g_S_TrimRegister[35],	26, POWER_UNIT);
//////////		PiDatalog(func, A_Eetr36_Icc1_S,      g_S_TrimRegister[36],	26, POWER_UNIT);
//////////		PiDatalog(func, A_Eetr37_Icc2_S,      g_S_TrimRegister[37],	26, POWER_UNIT);
//////////		
//////////
