...
////	if(gDisplay_FuncNum)
////		PiDatalog(func, A_Func_Num_tOVL_Pre_S, gFuncNum, 14, POWER_UNIT);
////
...
////
////	// Datalog
////	PiDatalog(func, A_tOVL_Pt_S, tOVL_Pt_S, 14,	POWER_MICRO);
////
////	// Test Time End //
////	if (g_p_TstTime_Enble)
////	{
////		g_endtime = g_mytimer.GetElapsedTime();
////		tOVL_Pre_S_TT = (g_endtime - g_begintime)*1e-6;
////		PiDatalog(func, A_tOVL_Pre_S_TT, tOVL_Pre_S_TT, 14, POWER_MILLI);
////	}
////
