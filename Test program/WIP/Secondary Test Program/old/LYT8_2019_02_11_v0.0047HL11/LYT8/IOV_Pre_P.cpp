...
////	if(gDisplay_FuncNum)
////		PiDatalog(func, A_Func_Num_IOV_Pre_P, gFuncNum, 24,	POWER_UNIT);
////
...
////	BPP_ovi->set_current(BPP_ch, 30e-3,	RANGE_30_MA); // Set current range now to prevent glitch later. //
////
////	// Power Up //
...
////	wait.delay_10_us(200);
////	FW_dvi->set_voltage(FW_ch, 1.0, VOLT_10_RANGE);	// DVI_11_1
////	wait.delay_10_us(200);
...
////	wait.delay_10_us(20);
////	UpperLimit = (func.dlog->tests[A_iOV_plus_pre].f_max_limit_val[0])*1.2; // Get upper search limit //
////	LowerLimit = (func.dlog->tests[A_iOV_plus_pre].f_min_limit_val[0])*0.8; // Get lower search limit //
////	search_IOVp_Binary(&iOV_plus_pre, LowerLimit, UpperLimit);
...
////
////	// Datalog //
////	PiDatalog(func, A_iOV_plus_pre, iOV_plus_pre, 24, POWER_MICRO);
////
////	// Test Time End //
////	if (g_TstTime_Enble_P)
////	{
////		g_endtime = g_mytimer.GetElapsedTime();
////		IOV_Pre_P_TT = (g_endtime - g_begintime)*1e-6;
////		PiDatalog(func, A_IOV_Pre_P_TT, IOV_Pre_P_TT, 24, POWER_MILLI);
////	}
////
