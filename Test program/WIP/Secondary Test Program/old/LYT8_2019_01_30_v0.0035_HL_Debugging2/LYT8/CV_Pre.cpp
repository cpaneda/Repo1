...
Pulse pulse;
	...
	//Measure direct at input of the comparator.  Measured value is too low.  Need to verify with bench.
	//0x00 0x44 0x10 0x00 ==> ZTMC_Avref_1p25V to FB pin.
	//DSM_I2C_Write('w', 0x44, 0x0010); 
