...
Pulse pulse;
	...
	IRSET_S_code[i] =  8; IRSET_S_TrimWt[i] =  2.2;    i++;     //0 (1 link trimmed-->  2.2%)
	IRSET_S_code[i] =  9; IRSET_S_TrimWt[i] =  4.4;    i++;     //0 (2 link trimmed-->  4.4%)
	IRSET_S_code[i] = 10; IRSET_S_TrimWt[i] =  6.6;    i++;     //0 (2 link trimmed-->  6.6%)
	IRSET_S_code[i] = 11; IRSET_S_TrimWt[i] =  8.8;    i++;     //0 (3 link trimmed-->  8.8%)
	IRSET_S_code[i] = 12; IRSET_S_TrimWt[i] =  11;     i++;     //0 (2 link trimmed-->  11%)
	IRSET_S_code[i] = 13; IRSET_S_TrimWt[i] =  12.2;   i++;     //0 (3 link trimmed-->  13.2%)
	IRSET_S_code[i] = 14; IRSET_S_TrimWt[i] =  15.4;   i++;     //0 (3 link trimmed-->  15.4%)
	IRSET_S_code[i] = 15; IRSET_S_TrimWt[i] =  17.7;   i++;     //0 (4 link trimmed-->  17.7%)
	...
	DSM_I2C_Write('w', g_S_TEST_CTRL1, 0x0004);

	wait.delay_10_us(100);

	IRSEET_pt_S = IS_dvi2k->measure_average(25);
	//---------------------------------------------------------------------------------
		//--------------------------------------------------------------------------------
	//Powerdown
	//-------------------------------------------------------------------------------
