...
Pulse pulse;
	...
	IS_dvi2k->set_voltage(IS_ch, 0, VOLT_1_RANGE);
	//wait.delay_10_us(100);
...
////////////////pulse.do_pulse();
	...
	//0x00 0x60 write 0x00 0x40  
	DSM_I2C_Write('w', g_TEST_CTRL1, 0x4002);

	//ZTMC_Enbl_FBspCC (Use FB to sample CC reference) & ZTMC_Dsbl_offPass
	//0x00 0x46 write 0x00 0x06
	DSM_I2C_Write('w', g_ANA_CTRL_1, 0x0600);
