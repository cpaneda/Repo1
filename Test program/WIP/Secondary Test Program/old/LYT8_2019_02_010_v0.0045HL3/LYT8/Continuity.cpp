...
////////////	//------------------------------
////////////	int Primary_Erase_Trim = 0;
////////////	if(Primary_Erase_Trim)
////////////	{
...
////////////		*/
////////////
////////////		//CX  DSM has to be re-init after the ERASE otherwise the ramp up of the search for vDrain_Write_th does not 
////////////		//    have the correct Vpin response due to TS is toggled and kicked out of I2C mode.
////////////		
////////////		//Power down TS_SCL & Vpin SDA pullup voltage first.
////////////		////TS_ovi3->set_current(TSovi3_ch, 30e-3, RANGE_30_MA);
////////////		////TS_ovi3->set_voltage(TSovi3_ch, 0.0, VOLT_10_RANGE); // OVI_3_0
////////////		////UV_dvi->set_current(UV_ch, 300e-3, RANGE_300_MA);
////////////		////UV_dvi->set_voltage(UV_ch,		0.0, VOLT_10_RANGE); // DVI_21_1
...
////////////
//////////////float DSM_Init_TT = (g_endtime - g_begintime);
////////////
//////////////printf("---------------------------------------------------------------------\n");
//////////////printf("--------------DSM Initialization time is = %8.3f ms\n",DSM_Init_TT/1000.0);
//////////////printf("---------------------------------------------------------------------\n");
////////////
//////////////Power-up I2C
...
////////////		g_Debug = 1;
////////////		if(Primary_Erase_Trim)  //Just in case the readback returns zeros the first time.
////////////		{
////////////			DSM_I2C_Read(0xC4);	    //Sometime, the first readback returns all zeros without doing the read to get out of EEprom Write mode.
////////////		}
////////////		DSM_I2C_Read(0xC4);
